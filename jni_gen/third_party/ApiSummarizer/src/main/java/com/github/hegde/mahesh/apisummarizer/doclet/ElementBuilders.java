...
public class ElementBuilders {
    ...
    public Field field(VariableElement e) {
        ...
        field.modifiers = e.getModifiers().stream()
        ...
        for (var key : values.keySet()) {
            ...
            if (obj instanceof String || obj instanceof Number) {
                ...
                annotation.properties.put(
                        ...
                        val.accept(new AnnotationVisitor(this), null));
            }
        }
        return annotation;
    }
            ...
            case DECLARED:
                ...
                u.type =
                        new TypeUsage.DeclaredType(
                                name, element.getSimpleName().toString(), params);
                break;
            case TYPEVAR:
                ...
                // infinite recursion.
                u.type =
                        new TypeUsage.TypeVar(element.getSimpleName().toString());
                break;
            case ARRAY:
    ...
    public Method method(ExecutableElement e) {
        ...
        m.typeParams =
                e.getTypeParameters().stream().map(this::typeParam).collect(Collectors.toList());
