...
class CGenerator extends Visitor<Classes, Future<void>> {
  static const _autoGeneratedNotice =
      '''// Autogenerated by jnigen. DO NOT EDIT!

''';
  static const _includes = '''#include <stdint.h>
#include "jni.h"
#include "dartjni.h"

''';
  static const _defines = '''thread_local JNIEnv *jniEnv;
JniContext *jni;
...
''';
  static const _initializers = '''void setJniGetters(JniContext *(*cg)(void),
        JNIEnv *(*eg)(void)) {
    context_getter = cg;
    env_getter = eg;
}
...
''';
  static const _prelude =
      _autoGeneratedNotice + _includes + _defines + _initializers;
...
class _CResult extends TypeVisitor<String> {
  ...
  String visitPrimitiveType(PrimitiveType node) {
    ...
    if (node.name == 'void') {
      ...
      unionField = node.signature.toLowerCase();
      valuePart = '_result';
    }
    const exceptionPart = 'check_exception()';
    return '    return (JniResult){.value = {.$unionField = $valuePart}, '
