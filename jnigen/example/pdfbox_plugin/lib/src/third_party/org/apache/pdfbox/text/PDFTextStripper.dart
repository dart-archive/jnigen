...
class PDFTextStripper extends jni.JniObject {
  ...
  static const jni.JniType<PDFTextStripper> type = _PDFTextStripperType();
...
class _PDFTextStripperType extends jni.JniType<PDFTextStripper> {
  const _PDFTextStripperType();
