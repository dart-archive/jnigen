...
JniClassLookupResult (*DefineClass)(char* name, jobject loader, jbyte* buf, jsize bufLen);
...
JniResult (*ToReflectedMethod)(jclass cls, jmethodID methodId, jboolean isStatic);
JniClassLookupResult (*GetSuperclass)(jclass clazz);
JniResult (*IsAssignableFrom)(jclass clazz1, jclass clazz2);
JniResult (*ToReflectedField)(jclass cls, jfieldID fieldID, jboolean isStatic);
...
JniResult (*CallBooleanMethodA)(jobject obj, jmethodID methodId, jvalue* args);
...
JniResult (*CallNonvirtualObjectMethodA)(jobject obj, jclass clazz, jmethodID methodID, jvalue* args);
JniResult (*CallNonvirtualBooleanMethod)(jobject , jclass , jmethodID );
JniResult (*CallNonvirtualBooleanMethodV)(jobject , jclass , jmethodID , va_list );
JniResult (*CallNonvirtualBooleanMethodA)(jobject obj, jclass clazz, jmethodID methodID, jvalue* args);
...
JniResult (*CallNonvirtualByteMethodA)(jobject obj, jclass clazz, jmethodID methodID, jvalue* args);
...
JniResult (*CallNonvirtualCharMethodA)(jobject obj, jclass clazz, jmethodID methodID, jvalue* args);
...
JniResult (*CallNonvirtualShortMethodA)(jobject obj, jclass clazz, jmethodID methodID, jvalue* args);
...
JniResult (*CallNonvirtualIntMethodA)(jobject obj, jclass clazz, jmethodID methodID, jvalue* args);
...
JniResult (*CallNonvirtualLongMethodA)(jobject obj, jclass clazz, jmethodID methodID, jvalue* args);
...
JniResult (*CallNonvirtualFloatMethodA)(jobject obj, jclass clazz, jmethodID methodID, jvalue* args);
...
JniResult (*CallNonvirtualDoubleMethodA)(jobject obj, jclass clazz, jmethodID methodID, jvalue* args);
...
jthrowable (*CallNonvirtualVoidMethodA)(jobject obj, jclass clazz, jmethodID methodID, jvalue* args);
...
jthrowable (*SetStaticObjectField)(jclass clazz, jfieldID fieldID, jobject val);
jthrowable (*SetStaticBooleanField)(jclass clazz, jfieldID fieldID, jboolean val);
...
jthrowable (*SetStaticDoubleField)(jclass clazz, jfieldID fieldID, jdouble val);
...
JniResult (*NewObjectArray)(jsize length, jclass elementClass, jobject initialElement);
JniResult (*GetObjectArrayElement)(jobjectArray array, jsize index);
jthrowable (*SetObjectArrayElement)(jobjectArray array, jsize index, jobject val);
...
JniPointerResult (*GetBooleanArrayElements)(jbooleanArray array, jboolean* isCopy);
...
JniPointerResult (*GetShortArrayElements)(jshortArray array, jboolean* isCopy);
...
JniPointerResult (*GetDoubleArrayElements)(jdoubleArray array, jboolean* isCopy);
jthrowable (*ReleaseBooleanArrayElements)(jbooleanArray array, jboolean* elems, jint mode);
jthrowable (*ReleaseByteArrayElements)(jbyteArray array, jbyte* elems, jint mode);
jthrowable (*ReleaseCharArrayElements)(jcharArray array, jchar* elems, jint mode);
jthrowable (*ReleaseShortArrayElements)(jshortArray array, jshort* elems, jint mode);
jthrowable (*ReleaseIntArrayElements)(jintArray array, jint* elems, jint mode);
jthrowable (*ReleaseLongArrayElements)(jlongArray array, jlong* elems, jint mode);
jthrowable (*ReleaseFloatArrayElements)(jfloatArray array, jfloat* elems, jint mode);
jthrowable (*ReleaseDoubleArrayElements)(jdoubleArray array, jdouble* elems, jint mode);
jthrowable (*GetBooleanArrayRegion)(jbooleanArray array, jsize start, jsize len, jboolean* buf);
jthrowable (*GetByteArrayRegion)(jbyteArray array, jsize start, jsize len, jbyte* buf);
jthrowable (*GetCharArrayRegion)(jcharArray array, jsize start, jsize len, jchar* buf);
jthrowable (*GetShortArrayRegion)(jshortArray array, jsize start, jsize len, jshort* buf);
jthrowable (*GetIntArrayRegion)(jintArray array, jsize start, jsize len, jint* buf);
jthrowable (*GetLongArrayRegion)(jlongArray array, jsize start, jsize len, jlong* buf);
jthrowable (*GetFloatArrayRegion)(jfloatArray array, jsize start, jsize len, jfloat* buf);
jthrowable (*GetDoubleArrayRegion)(jdoubleArray array, jsize start, jsize len, jdouble* buf);
jthrowable (*SetBooleanArrayRegion)(jbooleanArray array, jsize start, jsize len, jboolean* buf);
jthrowable (*SetByteArrayRegion)(jbyteArray array, jsize start, jsize len, jbyte* buf);
jthrowable (*SetCharArrayRegion)(jcharArray array, jsize start, jsize len, jchar* buf);
jthrowable (*SetShortArrayRegion)(jshortArray array, jsize start, jsize len, jshort* buf);
jthrowable (*SetIntArrayRegion)(jintArray array, jsize start, jsize len, jint* buf);
jthrowable (*SetLongArrayRegion)(jlongArray array, jsize start, jsize len, jlong* buf);
jthrowable (*SetFloatArrayRegion)(jfloatArray array, jsize start, jsize len, jfloat* buf);
jthrowable (*SetDoubleArrayRegion)(jdoubleArray array, jsize start, jsize len, jdouble* buf);
JniResult (*RegisterNatives)(jclass clazz, JNINativeMethod* methods, jint nMethods);
...
jthrowable (*GetStringRegion)(jstring str, jsize start, jsize len, jchar* buf);
jthrowable (*GetStringUTFRegion)(jstring str, jsize start, jsize len, char* buf);
JniPointerResult (*GetPrimitiveArrayCritical)(jarray array, jboolean* isCopy);
jthrowable (*ReleasePrimitiveArrayCritical)(jarray array, void* carray, jint mode);
